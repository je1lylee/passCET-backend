...
def imagetoword(request):
    ...
    res = requests.post('https://aip.baidubce.com/rest/2.0/ocr/v1/general_basic/?access_token=24.bc474b328d8b28ecd81caa80044fa343.2592000.1574841349.282335-17173201', data=sendData, headers=headers)
    print(res.text)
