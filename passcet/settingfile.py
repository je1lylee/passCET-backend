...
PASSCET_VERSION = '1.0'
# 管理员邮箱设置
PASSCET_ADMIN_EMAIL_LIGUODONG = 'xxx@qq.com'
PASSCET_ADMIN_EMAIL_LIANJIE = 'xxx@qq.com'
# 错误返回
...
PASSCET_217_VERSION_CHECK_FAILED = '{"code":217,"status":"当前版本不是最新版本"}'
# 正确返回
...
PASSCET_113_VERSION_CHECK_OK = '{"code":113,"status":"当前版本为最新版本"}'
